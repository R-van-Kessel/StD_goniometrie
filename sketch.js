...
const DRAGON_OPACITY = 100;    // ← Transparantie: 0=onzichtbaar, 255=volledig zichtbaar, 150=half
...
function showInfo() {
    ...
    popup.innerHTML = `
        <h2 style="margin-top: 0;">
            <a href="https://r-van-kessel.github.io/Summon_the_Dragon/index.html" target="_blank" style="color: #F44336; text-decoration: none; cursor: pointer;">
                Summon the Dragon
            </a>
        </h2><br>
...
function setup() {
  ...
  // Positioneer knoppen NA het aanmaken ← VERPLAATST!
    ...
    // ← VOEG DIT ONDERAAN TOE voor p5.js Web Editor:
