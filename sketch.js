...
function createNavigation() {
  ...
  nav.innerHTML = `
    ...
    <a href="bovenbouw.html"><span class="emoji">🎓</span> Bovenbouw</a>
  `;
...
function generateQuestions() {
    ...
    // Kies willekeurig een zijde als extra gegeven
    let extraGegeven = floor(random(3)); // 0=c, 1=d, 2=e
    let zijdeWaarde = floor(random(5, 20)); // Willekeurige zijdelengte
...
function drawTriangleQuestion(block) {
    ...
    text1 += (data.gegeven1 === "a" || data.gegeven1 === "b")
        ? data.waarde1 + "°"
        : data.waarde1;
    ...
    if (data.gegeven2 !== "") {
        ...
        text2 += (data.gegeven2 === "a" || data.gegeven2 === "b")
            ? data.waarde2 + "°"
            : data.waarde2;
...
drawingContext.shadowColor = 'rgba(0,0,0,0.4)';
    ...
    textAlign(CENTER, CENTER);
    textStyle(BOLD);
    textSize(18); //tekstgrootte aanpassen
