...
pop();
    ...
    if (flashCounter > 100) {
        isFlashing = false;
        flashCounter = 0;  // Reset de counter
        
        // Check of er al games gespeeld zijn
        if (totalGamesPlayed >= 1) {
            // Doe niets, ga gewoon terug naar het normale scherm
            // De gebruiker moet de actieve game afmaken
        } else {
