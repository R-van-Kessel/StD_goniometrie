...
pop();
    ...
    if (flashCounter > 100) {
        ...
        if (totalGamesPlayed >= 1) {
            // Toon melding en start geen nieuwe game
            fill(255, 0, 0);
            textAlign(CENTER, CENTER);
            textSize(24);
            text('Je bent al bezig met de dino game!', width/2, height/2);
            text('Speel eerst je huidige game(s) af.', width/2, height/2 + 40);
        } else {
